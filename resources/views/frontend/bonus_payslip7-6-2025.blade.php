...
{{-- <div class="card shadow">
    <div class="salary-header">
        <h4 class="mb-0">Pay Slip -
            {{ $employeeData->fname || $employeeData->mname || $employeeData->lname
                ? trim("{$employeeData->fname} {$employeeData->mname} {$employeeData->lname}")
                : 'N/A' }}
            ({{ !empty($employeeData->emp_code) ? $employeeData->emp_code : '' }})</h4>
    </div>
    <div class="card-body">
        <div class="mb-4 row">
            <div class="col-md-6">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6 text-end">
                <a href="{{ url('employee-pay-slip-pdf/' . $employeeData->id) }}"><button
                        class="btn btn-primary mt-3">Download Payslip</button></a>
            </div>
        </div>
